...
#[async_trait]
impl<Types, I, F> Fetch<Types, I, BlockQueryData<Types>> for TestFetcher<F>
where
    Types: NodeType,
...
#[async_trait]
impl<Types, I, F> Fetch<Types, I, LeafQueryData<Types, I>> for TestFetcher<F>
where
    Types: NodeType,
    I: NodeImplementation<Types>,
    Block<Types>: QueryableBlock,
    Deltas<Types, I>: Resolvable<Block<Types>>,
    F: Fetch<Types, I, LeafQueryData<Types, I>>,
{
